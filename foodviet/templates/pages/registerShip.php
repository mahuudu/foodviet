...
<div class="container">
    <div class="row">
        <div class="col-md-12 col-lg-12 col-xl-12 col-12 col-sm-12">
            <form action="?action=doRegisterShip" method="post" id="fileForm" role="form">
                <fieldset><legend class="text-center"> ĐĂNG KÝ TRỞ THÀNH CHIẾN BINH SHIPER <span class="req"></span></legend>
