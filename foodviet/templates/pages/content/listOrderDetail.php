      ...
      <div class="footer">
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    ...
                    <?php if (isset($_SESSION['ship']['id'])): ?>
                        
                  
                    <?php $idShiper =  $_SESSION['ship']['id']; ?>

                    <form class="form-group"  method="POST" action="?action=ConfirmShip&id=<?php echo $id  ?>">
                        <input type="hidden" name="idShiper" value="<?php echo $idShiper;  ?>">
                        <input class="btn btn-success" type="submit" name="submit" value="Nhận">
                    </form>
                     <?php endif ?>
                </li>
            </ul>
